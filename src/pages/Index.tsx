...
const Index = () => {
  ...
  const schema = {
    ...
    "@type": "Person",
    name: "Ibidapo Isaac",
    alternateName: ["Isaac Solutions", "Temzy Marketer", "Isaac Scaling"],
    ...
    url: "https://isaacsolutions.com",
    sameAs: [
      "https://www.instagram.com/isaacsolutions",
      "https://x.com/Isaacsolutions",
      "https://www.linkedin.com/in/isaacsolutions",
      "https://www.tiktok.com/@isaacsolutiions",
      "https://www.fiverr.com/temzymarketer",
      "https://www.skool.com/@temzy-marketer-7857",
      "https://www.pinterest.com/isaacsolutions",
    ],
    knowsAbout: [
