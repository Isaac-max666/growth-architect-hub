...
const projects: Project[] = [
  {
    title: "Lagos Fashion Shopify Store",
    category: "Web Design",
    image: shopify,
    desc: "Full Shopify rebuild for a Lagos-based fashion brand with conversion-first product pages.",
    metric: "+187% conversion rate",
    quote: "Sales tripled in 60 days.",
    tall: true,
  },
  {
    title: "Faith Creator YouTube Launch",
    category: "Digital Marketing",
    image: youtube,
    desc: "Channel branding, thumbnail system & SEO setup for a creator launching from zero.",
    metric: "0 → 12k subs in 5 months",
    quote: "He turned my channel into a real business.",
  },
  {
    title: "Scaled Skool Community to 1.2k",
  ...
  },
  {
    ...
    category: "Branding",
    image: branding,
    desc: "Logo, color system, type and brand voice for an Afro-luxury lifestyle label.",
    metric: "Press features in 4 outlets",
    quote: "Our brand finally looks the part.",
    tall: true,
  },
  {
    title: "Viral IG Campaign — Beauty",
    category: "Digital Marketing",
    image: marketing,
    desc: "Reel strategy, hooks & paid amplification for a Nigerian beauty brand launch.",
